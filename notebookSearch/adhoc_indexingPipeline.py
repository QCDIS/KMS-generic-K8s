...
def get_most_starred_repos():
    ...
    for lang in languages:
        ...
        potentialQueries = [
            ...
            "Aerosols", "Carbon", "Dioxide", "Methane", "other", "Greenhouse", "Gases", "Cloud", "Properties", "Ozone",
            "Precursors", "for", "aerosols", "ozone",
            "Precursors", "Clouds", "Above-Ground", "Biomass", "Albedo", "Anthropogenic", "Greenhouse", "Gas", "Fluxes",
            "Anthropogenic", "Water",
            "Fire", "Fraction", "Absorbed", "Photosynthetically", "Active", "Radiation", "FAPAR", "Glaciers",
            "Groundwater", "Ice", "Sheets", "Ice", "Shelves",
            "Lakes", "Land", "Cover", "Land", "Surface", "Temperature", "Latent", "Sensible", "Heat", "Fluxes", "Leaf",
            "Area", "Index", "LAI", "Permafrost",
            "River", "Discharge", "Snow", "Soil", "Carbon", "Soil", "Moisture", "ICOS", "SeaDataNet", "LifeWatch",
            "AnaEE", "ACTRIS", "AQUACOSM", "ARISE", "DANUBIUS-RI", "DiSSCo",
            "workflow", "marine", "weather", "geography", "environment", "CO2", "EISCAT", "3D", "eLTER", "RI", "EMBRC",
            "EMSO", "EMPHASIS", "EPOS", "EUFAR", "Euro-Argo", "ERIC", "EUROFLEETS", "EuroGOOS", "EUROCHAMP", "HEMERA",
            "IAGOS",
            "INTERACT", "IS-ENES", "JERICO-RI", "SIOS", "atmosphere", "wave", "telecommunication", "electronics",
            "plankton", "temperature",
            "Nitrous", "birds", "Oxide", "Habitat", "Inbreeding", "Morphology", "Physiology", "Phenology", "Taxonomic",
            "diversity",
            ...
            "software engineering", "fuzzy", "math", "physics", "chemistry", "logic", "recommender", "lab", "biology",
            "organic", "green gas",
            "substance", "particle", "technology", "psychology", "atom", "periodic table", "astronomy", "Biochemistry",
            "bio", "cycle", "geometry",
            "Natural", "nature", "volcano", "crust", "lava", "oxygen", "carbon", "density", "gravity", "cell",
            "Pressure", "state", "deep learning", "Ocean", "stress", "stress", "ice", "level", "height", "temperature",
            "Subsurface", "temperature", "currents", "currents", "color",
            "Sea", "salinity", "subsurface", "salinity", "heat", "flux", "colour", "Sound", "Phytoplankton", "biomass",
            "diversity",
            "Nutrients", "Fish", "abundace", "Transient", "traces", "Particulate", "matter", "Nitrous", "oxide",
            "Stable", "carbon", "isotopes",
            "Dissolved", "organic", "carbon", "Microbe", "biomass", "diversity", "Invertebrate", "abundance",
            "distribution",
            "Marine", "turtles,", "birds,", "mammals", "abundance", "distribution", "Hard", "coral", "cover",
            "composition", "Seagrass", "cover", "composition",
            "Macroalgal", "canopy", "cover", "composition", "Mangrove", "cover", "composition", "Inorganic", "Carbon",
            "Nitrous", "Oxide",
            "Nutrients", "Oxygen", "Transient", "Tracers", "Marine", "Habitat", "Properties", "Genetic", "diversity",
            "richness", "heterozygosity",
            "Genetic", "differentiation", "number", "genetic", "units", "genetic", "distance", "Effective",
            "population", "size", "Inbreeding",
            "Species", "distributions", "Species", "abundances", "Morphology", "Physiology", "Phenology", "Movement",
            "Community", "abundance",
            "Taxonomic", "phylogenetic", "diversity", "Trait", "diversity", "Interaction", "diversity", "Primary",
            "productivity", "Ecosystem", "phenology",
            "Ecosystem", "disturbances", "Live", "cover", "fraction", "Ecosystem", "distribution", "Ecosystem",
            "Vertical", "Profile", "Precipitation",
            "Pressure", "Radiation", "budget", "Radiation", "Budget", "Wind", "Speed", "Direction", "Temperature",
            "Vapour",
        ...
        for query in potentialQueries:
            ...
            for repo in g.search_repositories(query.lower(), sort="stars", order="desc", language=lang):
                try:
                    ...
                    filename = re.sub(r'[^A-Za-z0-9 ]+', '', repo.name) + "_" + "_" + str(repo.id) + "_" + str(
                        repo.size)
